  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-mdb-ride="carousel" style="margin-top:200px">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <a href="sell.php"><img src="../media/sellYoursBefore.jpg" class="d-block w-100"
            alt="Vendez votre appareil avant d'en adopter un nouveau" /></a>
      </div>
      <div class="carousel-item">
        <a href="marketplace.php"><img src="../media/iPhone11lessWaste.jpg" class="d-block w-100"
            alt="less waste, buy refurbished" /></a>
      </div>
      <div class="carousel-item">
        <a href="marketplace.php"><img src="../media/samsungLessWaste.jpg" class="d-block w-100"
            alt="less waste, buy refurbished" /></a>
      </div>
    </div>
