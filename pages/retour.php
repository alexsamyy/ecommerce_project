...
<body>
    ...
    <div style="text-align:justify; padding:20px; height: 200px; margin-top:200px; margin-bottom:120px;">
        ...
        <h4 style="text-align:center">
            ...
            Nous vous rembourserons le montant prélevé suite à la bonne réception du produit.<br>
            <b>Le remboursement s'effectuera sous 14 jours ouvrés.</b><br>
            Dans le cas où les conditions de renvoi ne sont pas respectées, nous vous retournerons le produit.<br>
